...
include './Data/Conf/conf.php';
$config =  array(
    /* 模块相关配置 */
    'AUTOLOAD_NAMESPACE' 	=> array('Addons' => JY_ADDON_PATH), //扩展模块列表
    'MODULE_DENY_LIST'   	=> array('Common','Admin','Install'),
     // 允许访问的模块列表
	'MODULE_ALLOW_LIST'    	=>    array('Home','Article','User','Api'),
	'DEFAULT_MODULE'       	=>    'Admin',  // 默认模块

    /* 系统数据加密设置 */
    'DATA_AUTH_KEY' 		=> UC_AUTH_KEY, //默认数据加密KEY
